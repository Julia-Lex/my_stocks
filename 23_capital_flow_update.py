"""
23_capital_flow_update.py — 个股资金流入库(富途,断点续传,三市场)。
...
用法:
  ASTOCK_DB_USER=zhu .venv/bin/python 23_capital_flow_update.py                # A股全量(断点续传)
  ASTOCK_DB_USER=zhu .venv/bin/python 23_capital_flow_update.py --market hk    # 港股
  ASTOCK_DB_USER=zhu .venv/bin/python 23_capital_flow_update.py --limit 10     # 试跑
  ASTOCK_DB_USER=zhu .venv/bin/python 23_capital_flow_update.py --codes 300308.SZ,00700.HK
  ASTOCK_DB_USER=zhu .venv/bin/python 23_capital_flow_update.py --update       # 日增量(cron 用,
                                                                 # 忽略断点全量重拉,upsert 幂等)
  ASTOCK_DB_USER=zhu .venv/bin/python 23_capital_flow_update.py --reset [--market hk]
"""
